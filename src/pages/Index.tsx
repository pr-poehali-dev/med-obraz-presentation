...
const faqs = [
  ...
  },
  {
    ...
    a: "Нет. Встречи — это образовательный формат без выдачи документов. Если вам нужен документ о повышении квалификации, посмотрите курсы МедОбраз.",
  },
  {
    q: "Как встречи связаны с курсами МедОбраз?",
    a: "Темы встреч пересекаются с направлениями курсов МедОбраз. Если тема заинтересовала — после встречи вы найдёте ссылку на соответствующий курс для углублённого изучения.",
  },
];
