...
const schedule: ScheduleItem[] = [
  ...
  {
    date: "8 июля 2026",
    topic: "Перенос и контрперенос в психоаналитической работе: от невротического к психотическому",
    speaker: "Мельник Екатерина",
    confirmed: true,
    detail: {
      title: "«Перенос и контрперенос в психоаналитической работе: от невротического к психотическому»",
      speakerFull: "Мельник Екатерина Сергеевна",
      speakerBio: "Клинический и семейный психолог, психоаналитически ориентированный терапевт.",
      speakerPhoto: "https://cdn.poehali.dev/projects/5c2d535a-bd60-400c-8b75-58203cc5db1c/bucket/c86fe713-724d-48ad-b823-d6da5c20d1e3.jpg",
      description: [
        "Дифференциальная диагностика и технические стратегии на основе работ Гринсона, Ракера, Этчегоена и Кернберга.",
        "**1. История и развитие понятий перенос и контрперенос**",
        "**2. Характер переноса как диагностический маркер структурного уровня психической организации**",
        "**3. Сходства и отличия в технике анализа переноса**",
        "**4. Перенос в отношении к рабочему альянсу и реальным отношениям между аналитиком и пациентом**",
        "**5. Контрперенос как рабочий инструмент**",
        "В ходе встречи разберём клинические виньетки.",
      ],
      registerUrl: "#",
    },
  },
