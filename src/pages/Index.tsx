...
const schedule: ScheduleItem[] = [
  ...
  },
  {
    ...
    detail: {
      ...
      speakerBio: "Член Российской Психотерапевтической Ассоциации (РПА), Преподаватель Научно-Образовательного Центра Современных Медицинских Технологий, практикующий психолог с более чем 8-летним опытом.",
